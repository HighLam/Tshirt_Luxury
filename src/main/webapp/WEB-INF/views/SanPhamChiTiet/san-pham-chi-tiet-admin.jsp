...
<div class="wrapper">
    ...
    <div class="row">
        ...
        <div class="row mt-2" style="margin: 0;padding-right: 0">
            ...
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <td>
                        <img style="max-width: 100px" src="${pageContext.request.contextPath}/images/${s.anhSanPham.tenAnhSanPham}">
                    </td>
                    ...
                    <td>${s.trangThai==1?"Đang bán":"Chưa bán"}</td>
                    <td>${s.gia}</td>
                    <td>${s.moTa}</td>
                    <td>
                        ...
                        <a href="/t-shirt-luxury/admin/san-pham-chi-tiet/delete?id=${s.id}" onclick="return confirmDelete()" class="btn btn-danger rounded-pill" data-toggle="tooltip" data-placement="top"
                ...
                <div class="modal-body">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="floatingInput" placeholder="Tên Sản Phẩm"
                                name="idSanPham" value="${idSanPham}" >
                        <label for="floatingInput">Id Sản Phẩm</label>
                    </div>
                    <label for="fileInput">Chọn Ảnh</label>
                    <input type="file" name="tenAnhSanPham" class="form-control" id="fileInput" accept="image/*" >
                    ...
                    <div class="form-floating mb-3 mt-3">
                        <input type="number" class="form-control" id="floatingInput" placeholder="Giá" name="gia">
