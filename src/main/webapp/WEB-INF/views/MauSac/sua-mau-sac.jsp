    ...
    <div class="row mt-3 ">
        ...
        <div class="col-9" style="">
            <div class="row">
                ...
                <form action="/t-shirt-luxury/admin/mau-sac/update?id=${mauSac.id}" method="POST">
                    <div class="form-floating mb-3">
                        <input readonly name="maMauSac" type="text" class="form-control" id="floatingInput"  value="${mauSac.maMauSac}">
                        <label for="floatingInput">Mã Màu Sắc</label>
                    </div>
                    <div class="form-floating mb-3">
                        <input name="tenMauSac" type="text" class="form-control" id="floatingInputTenMauSac" placeholder="Tên Màu Sắc" value="${mauSac.tenMauSac}">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="form-check form-check-inline mt-2">
                            <input class="form-check-input" type="radio" name="trangThai" id="hoatDong"
                                   value="1" ${mauSac.trangThai == 1 ? 'checked' :''}>
                        ...
                        <div class="form-check form-check-inline mt-2">
                            <input class="form-check-input" type="radio" name="trangThai" id="khongHoatDong"
                                   value="0" ${mauSac.trangThai == 0 ? 'checked' :''}>
                            <label class="form-check-label" for="inlineRadio2">Không Hoạt Động</label>
                        </div>
                    </div>
                    <div class="form-floating mb-3 mt-3">
                        <input name="moTa" type="text" class="form-control" id="floatingInput" placeholder="Mô tả" value="${mauSac.moTa}">
                        <label for="floatingInput">Mô tả</label>
                    </div>
                    <p id="error-message" class="mb-3" style="color:red">${errorTenMauSac}</p>
