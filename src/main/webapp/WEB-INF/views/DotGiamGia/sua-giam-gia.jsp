                ...
                <form action="/t-shirt-luxury/admin/giam-gia/update?id=${dotGiamGia.id}" method="post">
                    <div class="modal-body">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingInput" placeholder="Mã Đợt Giảm Giá" name="maDotGiamGia" value="${dotGiamGia.maDotGiamGia}">
                            <label for="floatingInput">Mã Đợt Giảm Giá</label>
                        </div>

                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingInput" placeholder="Tên Đợt Giảm Giá" name="tenDotGiamGia" value="${dotGiamGia.tenDotGiamGia}">
                            <label for="floatingInput">Tên Đợt Giảm Giá</label>
                        </div>

                        <div class="form-floating mb-3">
                            <input type="number" class="form-control" id="floatingInput" placeholder="Giá Trị Giảm" name="giaTriGiam" value="${dotGiamGia.giaTriGiam}">
                        ...
                        <div class="mt-3">
                            ...
                            <div class="form-check form-check-inline mt-2">
                                <input class="form-check-input" type="radio" name="trangThai"
                                       value="1" ${dotGiamGia.trangThai == 1 ? 'checked' : ''}>
                                <label class="form-check-label">Hoạt Động</label>
                            </div>
                            <div class="form-check form-check-inline mt-2">
                                <input class="form-check-input" type="radio" name="trangThai"
                                       value="0" ${dotGiamGia.trangThai == 0 ? 'checked' : ''}>
