...
public String getSize(Model model) {
    ...
    public String sanPhamChiTietAdmin(Model model) {
    model.addAttribute("spct", sanPhamChiTietAdminRepo.findAll());
    return "SanPhamChiTiet/san-pham-chi-tiet-admin";
}
    ...
    public String sanPhamChiTietSave(
            ...
            @ModelAttribute("sanPham") SanPhamChiTiet sanPhamChiTiet){
