...
public class thongKeController {
    ...
    public String thongKe(Model model) {
        model.addAttribute("hoaDonThongKe", hoaDonRepo.getAllBill());
    ...
    public String locThongKe(
        ...
        if (ngayKetThuc == null) {
            ngayKetThuc = new Date(); // Ngày hiện tại
        }

        // Gọi repository để lấy số lượng hóa đơn, tổng doanh thu và danh sách hóa đơn
